...
if __name__ == "__main__":
    ...
    init_exposed = 0.001 * total_population
    init_infected = 0.001 * total_population
    ...
    df_infected.to_csv("Austria_infected_prediction_ablation2.csv", index=False)
    ...
    #
    print("betas_zero", betas_zero[-1])
    axs[2].plot(time_scale, betas_zero, "-", linewidth=2, color='r', label="betas_zero")  # ***
    axs[2].plot(time_scale, betas_vac, "-", linewidth=2, color='b', label="betas_vac")  # ***
    axs[2].set_xlim(datetime.date(starting_time), datetime.date(ending_time))  # ***
    axs[2].set_xlabel("Days")
    axs[2].set_ylabel("Transmission rates")
    axs[2].legend(loc='upper left')  # ***

    axs[3].plot(time_scale, trans_zero, "-", linewidth=2, color='r', label="trans_zero")  # ***
    axs[3].plot(time_scale, trans_vac, "-", linewidth=2, color='b', label="trans_vac")  # ***
