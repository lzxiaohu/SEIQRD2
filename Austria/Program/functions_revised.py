...
def SEIQRD2Fit(x_data, *args):
    ...
    init_NPIs_eff_zero_one = args[7: 13]  # ***
    init_NPIs_eff_zero_two = args[13: 19]  # ***
    init_NPIs_eff_vac_one = args[19: 25]  # ***
    init_NPIs_eff_vac_two = args[25: 29]  # ***
...
def fit(init, x_data, y_data, bounds):
    ...
    # print("bounds: ", bounds)
    # print("init:", init)
    popt, pcov = optimize.curve_fit(SEIQRD2Fit, x_data, y_data, p0=init, bounds=bounds, check_finite=False, maxfev=1e+7)
    return popt
...
def SPEIQRDSimulation(x_data, *args):
    ...
    init_delta = args[2]
    init_NPIs_delay_days = args[3]
    init_NPIs_eff = args[4: 10]  # a constant
...
def SVEIQRD2Fit(x_data, *args):
    ...
    init_NPIs_eff_zero = args[5: 11]  # ***
    init_NPIs_eff_vac = args[11: 15]  # ***
