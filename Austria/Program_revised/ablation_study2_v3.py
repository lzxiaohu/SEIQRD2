...
if __name__ == "__main__":
    ...
    plt.savefig("prediction_Austria_ablation2.png", dpi=400, bbox_inches='tight')
    plt.show()
    ...
    plt.savefig("transmissionrates_Austria_ablation2.png", dpi=400, bbox_inches='tight')
    plt.show()
