...
if __name__ == "__main__":
    ...
    df_infected.to_csv("Austria_infected_prediction_sensitivity.csv", index=False)  # ***
    ...
    plt.savefig("prediction_Austria_sensitivity.png", dpi=400, bbox_inches='tight')
    plt.show()
    ...
    plt.savefig("transmissionrates_Austria_sensitivity.png", dpi=400, bbox_inches='tight')
    plt.show()
