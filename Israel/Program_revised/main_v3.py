...
if __name__ == "__main__":
    ...
    # the first NPI
    axs[2].scatter(time_scale[5], 2.1, marker="v", color='r', s=8)  # for the unvaccinated
    axs[2].text(time_scale[6], 2.1, s=r"$C_{1}^{0}$", color='r', font={'size': 6})  # for the unvaccinated
    axs[2].scatter(time_scale[5], 1.9, marker="v", color='black', s=8)  # for the vaccinated
    axs[2].text(time_scale[6], 1.8, s=r"$C_{1}^{v}$", color='black', font={'size': 6})  # for the vaccinated
    # the second NPI
    axs[2].scatter(time_scale[19], 2.1, marker="v", color='r', s=8)  # for the unvaccinated
    axs[2].text(time_scale[20], 2.1, s=r"$C_{2}^{0}$", color='r', font={'size': 6})  # for the unvaccinated
    axs[2].scatter(time_scale[19], 1.9, marker="v", color='black', s=8)  # for the vaccinated
    axs[2].text(time_scale[20], 1.8, s=r"$C_{2}^{v}$", color='black', font={'size': 6})
    # the third NPI
    axs[2].scatter(time_scale[33], 2.1, marker="v", color='r', s=8)  # for the unvaccinated
    axs[2].text(time_scale[34], 2.1, s=r"$C_{3}^{0}$", color='r', font={'size': 6})  # for the unvaccinated
    # the fourth NPI
    axs[2].scatter(time_scale[65], 1.9, marker="v", color='black', s=8)  # for the vaccinated
    axs[2].text(time_scale[66], 1.9, s=r"$C_{3}^{v}$", color='black', font={'size': 6})  # for the vaccinated
