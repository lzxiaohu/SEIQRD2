...
def SEIQRD2Fit(x_data, *args):
    ...
    init_NPIs_eff_zero_one = args[7: 10]  # ***
    init_NPIs_eff_zero_two = args[10: 14]  # ***
    init_NPIs_eff_vac_one = args[14: 18]  # ***
    init_NPIs_eff_vac_two = args[18: 21]  # ***
...
def SVEIQRD2Fit(x_data, *args):
    ...
    init_NPIs_eff_zero = args[5: 8]  # ***
    init_NPIs_eff_vac = args[8: 11]  # ***
