...
if __name__ == "__main__":
    ...
    init_exposed = 1000000  # 0.005 * total_population  # a constant ***
    init_infected = 1000  # 0.0003 * total_population  # a constant ***
    ...
    df_infected.to_csv("Israel_infected_prediction_ablation1.csv", index=False)  # ***
    ...
    plt.savefig("prediction_Israel_ablation1.png", dpi=400, bbox_inches='tight')
    plt.show()
    ...
    plt.savefig("transmissionrates_Israel_ablation1.png", dpi=400, bbox_inches='tight')
    plt.show()
