...
if __name__ == "__main__":
    ...
    df_cases = pd.read_csv("Israel_wave2_integrated.csv")  # ***
    # the period of time
    ...
    init_vaccinated = 1e+5  # df_cases.iloc[0, 17] / 100 * total_population
    ...
    para_est = [2.75920431e-01,  5.28346419e-02,  7.51355831e-03,  2.90161899e+00,
                1.01138171e-01,  7.07378125e-02,  2.35493812e+00, -2.24953160e-08,
                -8.02275597e-02, -1.26691963e-01, -5.43882872e-14, -1.51492618e-04,
                -6.99635628e-07, -1.76664401e-01, -1.26176685e-06, -2.87060137e-03,
                -1.74489433e-09, -3.80395967e-12, -1.95802986e-26, -4.77462756e-03,
                -1.86630216e-05, -2.99999880e+00]
    ...
    beta_zero_ones, beta_zero_twos, beta_vac_ones, beta_vac_twos \
        = functions.Betas(para_est[6], NPIs_no_vac, NPIs_vac, para_est[0], para_est[1], para_est[2], para_est[3],
                          para_est[7: 11], para_est[11:15], para_est[15:19], para_est[19:22])
