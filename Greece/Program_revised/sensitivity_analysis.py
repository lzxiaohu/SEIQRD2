...
if __name__ == "__main__":
    ...
    init_exposed_zero = 2000  # *** 1.7e-4 * total_population; 1775
    init_exposed_vac = 2000   # *** 1e-4 * total_population; 1044
    init_infected_zero = 200  # *** 1.7e-4 * total_population ; 1500
    init_infected_vac = 200   # *** 1e-4 * total_population ; 1000
    ...
    df_infected.to_csv("Greece_infected_prediction_sensitivity.csv", index=False)
    ...
    plt.savefig("prediction_Greece_sensitivity.png", dpi=400, bbox_inches='tight')
    plt.show()
    ...
    plt.savefig("transmissionrates_Greece_sensitivity.png", dpi=400, bbox_inches='tight')
    plt.show()
