...
if __name__ == "__main__":
    ...
    # booster
    axs[0].scatter(time_scale[16], 1e3, marker="P", color="black", s=8)
    axs[0].text(time_scale[17], 2e2, s="PI", color="black", font={'size': 6})
    # the first NPIs
    axs[0].scatter(time_scale[21], 1e3, marker="^", color='r', s=8)  # for the unvaccinated
    axs[0].text(time_scale[22], 1e3, s=r"$R_{1}^{0}$", color='r', font={'size': 6})  # for the unvaccinated
    axs[0].scatter(time_scale[21], 3e3, marker="^", color='black', s=8)  # for the vaccinated
    axs[0].text(time_scale[22], 3e3, s=r"$R_{1}^{v}$", color='black', font={'size': 6})  # for the vaccinated
    # the second NPIs
    axs[0].scatter(time_scale[49], 10e3, marker="v", color='r', s=8)  # for the unvaccinated
    axs[0].text(time_scale[50], 10e3, s=r"$C_{1}^{0}$", color='r', font={'size': 6})  # for the unvaccinated
    # the third NPIs
    axs[0].scatter(time_scale[65], 10e3, marker="v", color='r', s=8)  # for the unvaccinated
    axs[0].text(time_scale[66], 10e3, s=r"$C_{2}^{0}$", color='r', font={'size': 6})  # for the unvaccinated
    ...
    axs[1].scatter(time_scale[16], 0.05, marker="P", color="black", s=8)
    # axs[1].annotate('start boosters', xy=(time_scale[17], 0.05), xytext=(time_scale[30], 0.1),
    #                 arrowprops=dict(arrowstyle="->"))
    axs[1].text(time_scale[17], 0.01, s=r"start boosters", color='black', font={'size': 8})
    ...
    axs[2].scatter(time_scale[21], 0.4, marker="^", color='r', s=8)
    axs[2].text(time_scale[22], 0.1, s=r"$R_{1}^{0}$", color='r', font={'size': 6})
    axs[2].scatter(time_scale[21], 0.7, marker="^", color='black', s=8)
    axs[2].text(time_scale[22], 0.6, s=r"$R_{1}^{v}$", color='black', font={'size': 6})
    axs[2].scatter(time_scale[49], 3.0, marker="v", color='r', s=8)  # for the unvaccinated
    axs[2].text(time_scale[50], 2.9, s=r"$C_{1}^{0}$", color='r', font={'size': 6})
    axs[2].scatter(time_scale[65], 3.0, marker="v", color='r', s=8)  # for the unvaccinated
    axs[2].text(time_scale[66], 2.9, s=r"$C_{2}^{0}$", color='r', font={'size': 6})
